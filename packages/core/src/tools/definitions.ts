  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        rotSpeed: { type: 'array', items: { type: 'number' }, description: '[min, max] rotation speed in degrees/s' },
        rotation: { type: 'array', items: { type: 'number' }, description: '[min, max] initial rotation in degrees' },
